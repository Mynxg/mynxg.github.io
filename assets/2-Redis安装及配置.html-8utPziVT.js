import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,e}from"./app-DiUId5lf.js";const i={},l=e(`<h2 id="一、准备工作" tabindex="-1"><a class="header-anchor" href="#一、准备工作"><span>一、准备工作</span></a></h2><p>redis版本下载：<a href="https://redis.io/downloads/" target="_blank" rel="noopener noreferrer">https://redis.io/downloads/</a></p><blockquote><p>需要登录</p></blockquote><p>redis客户端下载：<a href="https://github.com/RedisInsight/RedisDesktopManager" target="_blank" rel="noopener noreferrer">https://github.com/RedisInsight/RedisDesktopManager</a></p><h2 id="二、安装-配置" tabindex="-1"><a class="header-anchor" href="#二、安装-配置"><span>二、安装 &amp; 配置</span></a></h2><blockquote><p>安装教程：<a href="https://blog.csdn.net/m0_62617719/article/details/131243067" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/m0_62617719/article/details/131243067</a></p></blockquote><blockquote><p>安装步骤下一步下一步</p></blockquote><blockquote><p>注意：</p><p>1、配置redis.windows.conf默认或者修改你需要的端口，</p><p>2、redis默认没有设置密码</p></blockquote><p>启动Redis：</p><blockquote><p>在D:\\software\\redis\\Redis-x64-5.0.14.1目录下执行以下命令：</p></blockquote><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>.\\redis-server.exe redis.windows.conf</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>客户端连接：RedisDesktopManager</p><p>连接方式：正常输入ip端口即可</p><h2 id="附件" tabindex="-1"><a class="header-anchor" href="#附件"><span>附件</span></a></h2><p>redis配置：</p><blockquote><p>位置：D:\\software\\redis\\Redis-x64-5.0.14.1\\redis.windows.conf</p></blockquote><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span># Redis configuration file example</span></span>
