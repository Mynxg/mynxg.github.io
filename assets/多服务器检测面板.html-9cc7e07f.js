...
<span class="token comment"># 状态查看</span>
systemctl status stat_client
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>都安装完成后如图所示： <img src="`+_+`" alt="" loading="lazy"></p><p>将客户端注册到服务端上：</p><p>打开 stat_client.service 文件：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>vim /etc/systemd/system/stat_client.service
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>修改如下图所示：</p><figure><img src="`+g+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>配置修改如下：</p><figure><img src="'+h+'" alt="image-20230626014148113" tabindex="0" loading="lazy"><figcaption>image-20230626014148113</figcaption></figure><h2 id="搭建nginx反向代理" tabindex="-1"><a class="header-anchor" href="#搭建nginx反向代理" aria-hidden="true">#</a> 搭建nginx反向代理</h2>',14),T=s("p",null,"主要是用于将带有端口号的地址反向代理为一个域名（二级域名）",-1),D=s("p",null,"如果你使用ip地址+端口号的形式访问就不需要反向代理了，也就省下这一步骤。",-1),G={href:"https://iocky.com/archives/13",target:"_blank",rel:"noopener noreferrer"},J={href:"https://blog.laoda.de/archives/ward-serverstatus-install",target:"_blank",rel:"noopener noreferrer"},M=t(`<h2 id="卸载服务端和客户端" tabindex="-1"><a class="header-anchor" href="#卸载服务端和客户端" aria-hidden="true">#</a> 卸载服务端和客户端：</h2><ol><li>先停掉 之前开启的服务 查看服务状态：</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>systemctl status stat_server
systemctl status stat_client
