import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as r,c as o,b as n,d as s,a,f as p}from"./app-06f50d85.js";const c={},t=p(`<h2 id="标准的配置文件" tabindex="-1"><a class="header-anchor" href="#标准的配置文件" aria-hidden="true">#</a> 标准的配置文件</h2><p>访问者、被访问者都修改frpc.ini,中间的媒婆服务器修改frps.ini，其中的c就是client客户端，s指server服务器。</p><p>被访问者：frpc.ini</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>common<span class="token punctuation">]</span>
