import{aP as i,Q as l,S as r,U as n,ac as s,ae as a,aQ as o,E as p}from"./framework-1a3f7ddc.js";const t={},c=o(`<hr><h1 id="当前页面内容标题" tabindex="-1"><a class="header-anchor" href="#当前页面内容标题" aria-hidden="true">#</a> 当前页面内容标题</h1><p>title: frp-p2p配置说明</p><h1 id="当前页面图标" tabindex="-1"><a class="header-anchor" href="#当前页面图标" aria-hidden="true">#</a> 当前页面图标</h1><p>icon: sliders</p><h1 id="分类" tabindex="-1"><a class="header-anchor" href="#分类" aria-hidden="true">#</a> 分类</h1><p>category:</p><ul><li>frp</li></ul><h1 id="标签" tabindex="-1"><a class="header-anchor" href="#标签" aria-hidden="true">#</a> 标签</h1><p>tag:</p><ul><li>frps</li><li>远程桌面</li><li>p2p sticky: false</li></ul><h1 id="是否收藏在博客主题的文章列表中-当填入数字时-数字越大-排名越靠前。" tabindex="-1"><a class="header-anchor" href="#是否收藏在博客主题的文章列表中-当填入数字时-数字越大-排名越靠前。" aria-hidden="true">#</a> 是否收藏在博客主题的文章列表中，当填入数字时，数字越大，排名越靠前。</h1><p>star: false</p><h1 id="是否将该文章添加至文章列表中" tabindex="-1"><a class="header-anchor" href="#是否将该文章添加至文章列表中" aria-hidden="true">#</a> 是否将该文章添加至文章列表中</h1><p>article: true</p><h1 id="是否将该文章添加至时间线中" tabindex="-1"><a class="header-anchor" href="#是否将该文章添加至时间线中" aria-hidden="true">#</a> 是否将该文章添加至时间线中</h1><h2 id="timeline-truedate-2023-10-14-16-12-00" tabindex="-1"><a class="header-anchor" href="#timeline-truedate-2023-10-14-16-12-00" aria-hidden="true">#</a> timeline: true date: 2023-10-14 16:12:00</h2><h2 id="标准的配置文件" tabindex="-1"><a class="header-anchor" href="#标准的配置文件" aria-hidden="true">#</a> 标准的配置文件</h2><p>访问者、被访问者都修改frpc.ini,中间的媒婆服务器修改frps.ini，其中的c就是client客户端，s指server服务器。</p><p>被访问者：frpc.ini</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>common<span class="token punctuation">]</span>
...
frpc -c frpc.ini 
exit
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>将cd后的路径更改为你的frpc实际存放的目录。</p></blockquote><blockquote><p>之后直接运行这个 .bat 文件即可启动frpc并隐藏窗口（可在任务管理器中退出）。<br> 至于开机启动，把这个 .bat 文件直接扔进Windows的开机启动文件夹就好了 😃<br> 至此，客户端配置完成，之后就是你自己根据需要在frpc.ini后追加规则即可。<br> 强烈建议你在使用frp直接测试内网穿透前，先在局域网内测试好相关功能的正常使用，并配置好可能会影响的Windows防火墙等内容，在内网调试通过后再使用frp进行内网穿透测试。</p></blockquote>`,38),d={href:"https://www.cnblogs.com/shengruxiahuaya/p/17150459.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://www.vuar.cn/index.php/archives/74/",target:"_blank",rel:"noopener noreferrer"},m=n("h2",{id:"附件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#附件","aria-hidden":"true"},"#"),s(" 附件")],-1),u={href:"https://zhuanlan.zhihu.com/p/575316935",target:"_blank",rel:"noopener noreferrer"},b={href:"https://gofrp.org/docs/features/xtcp/",target:"_blank",rel:"noopener noreferrer"},k={href:"https://doc.natfrp.com/app/xtcp.html",target:"_blank",rel:"noopener noreferrer"};function h(_,f){const e=p("ExternalLinkIcon");return l(),r("div",null,[c,n("p",null,[s("windows开机自启动bat文件： "),n("a",d,[s("https://www.cnblogs.com/shengruxiahuaya/p/17150459.html"),a(e)])]),n("p",null,[s("开机自启可以参考："),n("a",v,[s("https://www.vuar.cn/index.php/archives/74/"),a(e)])]),m,n("p",null,[s("参考："),n("a",u,[s("https://zhuanlan.zhihu.com/p/575316935"),a(e)])]),n("p",null,[s("xtcp使用解释："),n("a",b,[s("https://gofrp.org/docs/features/xtcp/"),a(e)])]),n("p",null,[s("xtcp参考："),n("a",k,[s("https://doc.natfrp.com/app/xtcp.html"),a(e)])])])}const x=i(t,[["render",h],["__file","frp-p2p配置说明.html.vue"]]);export{x as default};
