import{aP as o,Q as p,S as r,U as n,ac as s,ae as e,aQ as i,E as l}from"./framework-1a3f7ddc.js";const t={},c=n("h2",{id:"背景",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#背景","aria-hidden":"true"},"#"),s(" 背景")],-1),d=n("p",null,"国内服务器贵，并且宽带越高越贵。在连接一个远程桌面的时候就可能很卡了。而且你想使用国外vps时，连接的时候延迟太高，连接也很卡。想节省服务器带宽或者服务器带宽不理想，由此frp 使用 p2p 模式，点对点穿透，可节约服务器带宽。",-1),u=n("blockquote",null,[n("p",null,[n("strong",null,"对等式网络"),s("（peer-to-peer， 简称P2P），又称点对点技术，是无中心服务器、依靠用户群（peers）交换信息的互联网体系，它的作用在于，减低以往网路传输中的节点，以降低资料遗失的风险。")]),n("p",null,"优点：仅少量占用服务器带宽，占用的带宽可忽略不计，传输大文件利器！")],-1),v=n("h2",{id:"准备工作",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#准备工作","aria-hidden":"true"},"#"),s(" 准备工作")],-1),b={href:"https://blog.nnxx.me/posts/e7d9824f.html",target:"_blank",rel:"noopener noreferrer"},m=i(`<blockquote><p>注意：上面的操作能实现，下面的配置操作就基本简单了。</p><p>下载frp安装包(frp_0.51.2_windows_386)、一台有公网ip的服务器</p></blockquote><pre><code>实现p2p远程连接，需要两台电脑都安装和配置好客户端
