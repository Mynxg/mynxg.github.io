import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as r,c as o,b as n,d as s,a,e as p}from"./app-4191c28c.js";const c={},t=p(`<h2 id="标准的配置文件" tabindex="-1"><a class="header-anchor" href="#标准的配置文件" aria-hidden="true">#</a> 标准的配置文件</h2><p>访问者、被访问者都修改frpc.ini,中间的媒婆服务器修改frps.ini，其中的c就是client客户端，s指server服务器。</p><p>被访问者：frpc.ini</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>common<span class="token punctuation">]</span>
...
frpc -c frpc.ini 
exit
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>将cd后的路径更改为你的frpc实际存放的目录。</p></blockquote><blockquote><p>之后直接运行这个 .bat 文件即可启动frpc并隐藏窗口（可在任务管理器中退出）。<br> 至于开机启动，把这个 .bat 文件直接扔进Windows的开机启动文件夹就好了 😃<br> 至此，客户端配置完成，之后就是你自己根据需要在frpc.ini后追加规则即可。<br> 强烈建议你在使用frp直接测试内网穿透前，先在局域网内测试好相关功能的正常使用，并配置好可能会影响的Windows防火墙等内容，在内网调试通过后再使用frp进行内网穿透测试。</p></blockquote>`,21),d=n("br",null,null,-1),v={href:"https://www.cnblogs.com/shengruxiahuaya/p/17150459.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.vuar.cn/index.php/archives/74/",target:"_blank",rel:"noopener noreferrer"},u=n("h2",{id:"附件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#附件","aria-hidden":"true"},"#"),s(" 附件")],-1),b={href:"https://zhuanlan.zhihu.com/p/575316935",target:"_blank",rel:"noopener noreferrer"},k={href:"https://gofrp.org/docs/features/xtcp/",target:"_blank",rel:"noopener noreferrer"},_={href:"https://doc.natfrp.com/app/xtcp.html",target:"_blank",rel:"noopener noreferrer"};function h(f,g){const e=l("ExternalLinkIcon");return r(),o("div",null,[t,n("p",null,[s("windows开机自启动bat文件："),d,n("a",v,[s("https://www.cnblogs.com/shengruxiahuaya/p/17150459.html"),a(e)])]),n("p",null,[s("开机自启可以参考："),n("a",m,[s("https://www.vuar.cn/index.php/archives/74/"),a(e)])]),u,n("p",null,[s("参考："),n("a",b,[s("https://zhuanlan.zhihu.com/p/575316935"),a(e)])]),n("p",null,[s("xtcp使用解释："),n("a",k,[s("https://gofrp.org/docs/features/xtcp/"),a(e)])]),n("p",null,[s("xtcp参考："),n("a",_,[s("https://doc.natfrp.com/app/xtcp.html"),a(e)])])])}const q=i(c,[["render",h],["__file","frp-p2p配置说明.html.vue"]]);export{q as default};
